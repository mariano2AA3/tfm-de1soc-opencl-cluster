...
set_module_property NAME laplacian_system
set_module_property VERSION 14.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME laplacian_system
...
### SLAVE interface avs_laplacian_cra
add_interface avs_laplacian_cra avalon end
set_interface_property avs_laplacian_cra addressAlignment DYNAMIC
set_interface_property avs_laplacian_cra burstOnBurstBoundariesOnly false
set_interface_property avs_laplacian_cra explicitAddressSpan 0
set_interface_property avs_laplacian_cra holdTime 0
set_interface_property avs_laplacian_cra isMemoryDevice false
set_interface_property avs_laplacian_cra isNonVolatileStorage false
set_interface_property avs_laplacian_cra linewrapBursts false
set_interface_property avs_laplacian_cra maximumPendingReadTransactions 1
set_interface_property avs_laplacian_cra printableDevice false
set_interface_property avs_laplacian_cra readLatency 0
set_interface_property avs_laplacian_cra readWaitTime 0
set_interface_property avs_laplacian_cra setupTime 0
set_interface_property avs_laplacian_cra timingUnits Cycles
set_interface_property avs_laplacian_cra writeWaitTime 0
set_interface_property avs_laplacian_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_laplacian_cra ENABLED true
add_interface_port avs_laplacian_cra avs_laplacian_cra_read read Input 1
add_interface_port avs_laplacian_cra avs_laplacian_cra_write write Input 1
add_interface_port avs_laplacian_cra avs_laplacian_cra_address address Input 4
add_interface_port avs_laplacian_cra avs_laplacian_cra_writedata writedata Input 64
add_interface_port avs_laplacian_cra avs_laplacian_cra_byteenable byteenable Input 8
add_interface_port avs_laplacian_cra avs_laplacian_cra_readdata readdata Output 64
add_interface_port avs_laplacian_cra avs_laplacian_cra_readdata readdata Output 64
add_interface_port avs_laplacian_cra avs_laplacian_cra_readdatavalid readdatavalid Output 1
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL laplacian_system
...
add_fileset_file laplacian.v SYSTEM_VERILOG PATH laplacian.v TOP_LEVEL_FILE
add_fileset_file laplacian_system.v SYSTEM_VERILOG PATH laplacian_system.v TOP_LEVEL_FILE
...
set_fileset_property SIM_VERILOG TOP_LEVEL laplacian_system
add_fileset_file acl_data_fifo.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_data_fifo.v TOP_LEVEL_FILE
add_fileset_file acl_fifo.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_fifo.v TOP_LEVEL_FILE
add_fileset_file acl_ll_fifo.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_ll_fifo.v TOP_LEVEL_FILE
add_fileset_file acl_ll_ram_fifo.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_ll_ram_fifo.v TOP_LEVEL_FILE
