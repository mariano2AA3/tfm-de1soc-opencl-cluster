...
set_module_property NAME ErrorDiffusion_system
set_module_property VERSION 14.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME ErrorDiffusion_system
...
### SLAVE interface avs_errorDiffusion_cra
add_interface avs_errorDiffusion_cra avalon end
set_interface_property avs_errorDiffusion_cra addressAlignment DYNAMIC
set_interface_property avs_errorDiffusion_cra burstOnBurstBoundariesOnly false
set_interface_property avs_errorDiffusion_cra explicitAddressSpan 0
set_interface_property avs_errorDiffusion_cra holdTime 0
set_interface_property avs_errorDiffusion_cra isMemoryDevice false
set_interface_property avs_errorDiffusion_cra isNonVolatileStorage false
set_interface_property avs_errorDiffusion_cra linewrapBursts false
set_interface_property avs_errorDiffusion_cra maximumPendingReadTransactions 1
set_interface_property avs_errorDiffusion_cra printableDevice false
set_interface_property avs_errorDiffusion_cra readLatency 0
set_interface_property avs_errorDiffusion_cra readWaitTime 0
set_interface_property avs_errorDiffusion_cra setupTime 0
set_interface_property avs_errorDiffusion_cra timingUnits Cycles
set_interface_property avs_errorDiffusion_cra writeWaitTime 0
set_interface_property avs_errorDiffusion_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_errorDiffusion_cra ENABLED true
add_interface_port avs_errorDiffusion_cra avs_errorDiffusion_cra_read read Input 1
add_interface_port avs_errorDiffusion_cra avs_errorDiffusion_cra_write write Input 1
add_interface_port avs_errorDiffusion_cra avs_errorDiffusion_cra_address address Input 4
add_interface_port avs_errorDiffusion_cra avs_errorDiffusion_cra_writedata writedata Input 64
add_interface_port avs_errorDiffusion_cra avs_errorDiffusion_cra_byteenable byteenable Input 8
add_interface_port avs_errorDiffusion_cra avs_errorDiffusion_cra_readdata readdata Output 64
add_interface_port avs_errorDiffusion_cra avs_errorDiffusion_cra_readdata readdata Output 64
add_interface_port avs_errorDiffusion_cra avs_errorDiffusion_cra_readdatavalid readdatavalid Output 1
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL ErrorDiffusion_system
...
add_fileset_file ErrorDiffusion.v SYSTEM_VERILOG PATH ErrorDiffusion.v TOP_LEVEL_FILE
add_fileset_file ErrorDiffusion_system.v SYSTEM_VERILOG PATH ErrorDiffusion_system.v TOP_LEVEL_FILE
...
set_fileset_property SIM_VERILOG TOP_LEVEL ErrorDiffusion_system
add_fileset_file acl_int_mult.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_int_mult.v TOP_LEVEL_FILE
add_fileset_file sv_mult27.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/sv_mult27.v TOP_LEVEL_FILE
add_fileset_file acl_data_fifo.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_data_fifo.v TOP_LEVEL_FILE
add_fileset_file acl_fifo.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_fifo.v TOP_LEVEL_FILE
