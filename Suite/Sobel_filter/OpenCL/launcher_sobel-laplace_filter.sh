...
# ./launcher_sobel-laplace_filter.sh [sobel_filter | laplacian_filter] [sobel.aocx | laplacian.aocx] 1_butterflies.ppm 1920 1080
...
do
  ...
  ssh root@${NODES[i]} "./launch2.sh $OUTPATH/out $1 -img=imageIn_00_0$i.ppm -w=$WIDTH -h=$HEIGHT" &
